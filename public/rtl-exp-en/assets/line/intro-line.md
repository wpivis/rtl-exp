...
- Each year is represented by one dot in the linechart.<!-- - The vertical distance between the dot and the horizontal axis represents the number of arts curated during that year (the actual value is shown above the dot). A general rule of thumb is that the further away from the axis the dot is, the more arts were curated that year. -->
